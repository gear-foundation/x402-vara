...
import { BaseGearProgram, GearApi, HexString } from "@gear-js/api";
...
export class Vft {
  ...
  public subscribeToMintedEvent(
    callback: (
      data: { to: ActorId; value: number | string | bigint },
    ) => void | Promise<void>,
  ): Promise<() => void> {
  ...
  public subscribeToBurnedEvent(
    callback: (
      data: { from: ActorId; value: number | string | bigint },
    ) => void | Promise<void>,
  ): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent(
      "UserMessageSent",
  ...
  public subscribeToTransferEvent(
    callback: (
      data: { from: ActorId; to: ActorId; value: number | string | bigint },
    ) => void | Promise<void>,
  ): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent(
      "UserMessageSent",
